...
def create_logs(cw_log: CloudwatchLog):
    ...
    for day in range(start_day, end_day):
        ...
        write_full_log(stats, f"full_log_day_{start}_to_{end}", header=["timestamp", "request_uuid", "concierge service", "latency", "downstream service"])
    ...
    for file in os.listdir("./full_logs"):
        with open(f"./full_logs/{file}", newline='') as f:
            ...
            for i in range(1, len(file)):
                if file[i][1] not in services:
                    continue
                service = services[file[i][1]]
                service.count += 1
                match file[i][2]:
                    case "GetRateCalendar":
                        service.rate_calendar.count += 1
                        if float(file[i][3]) > 0.000001:
                            service.latency.append(float(file[i][3]))
                            service.rate_calendar.latency.append(float(file[i][3]))  
                        else:
                            service.errors += 1
                    ...
                    case "GetAvailability":
                        ...
                        if float(file[i][3]) > 0.000001:
                            service.latency.append(float(file[i][3]))
                            service.availability.latency.append(float(file[i][3]))    
                        else:
                            service.errors += 1
                    ...
                    case "GetRoomDetails":
                        ...
                        if float(file[i][3]) > 0.000001:
                            service.latency.append(float(file[i][3]))
                            service.room_details.latency.append(float(file[i][3]))
                        else:
                            service.errors += 1
                    ...
                    case "GetAddons":
                        ...
                        if float(file[i][3]) > 0.000001:
                            service.latency.append(float(file[i][3]))
                            service.addons.latency.append(float(file[i][3]))
                        else:
                            service.errors += 1
                    ...
                    case "GetPackage":
                        ...
                        if float(file[i][3]) > 0.000001:
                            service.latency.append(float(file[i][3]))
                            service.package.latency.append(float(file[i][3]))
                        else:
                            service.errors += 1
                    ...
                    case "GetRoomRate":
                        ...
                        if float(file[i][3]) > 0.000001:
                            service.latency.append(float(file[i][3]))
                            service.room_rate.latency.append(float(file[i][3]))
                        else:
                            service.errors += 1
                    ...
                    case "MakeReservation":
                        ...
                        if float(file[i][3]) > 0.000001:
                            service.latency.append(float(file[i][3]))
                            service.make_reservation.latency.append(float(file[i][3]))
                        else:
                            service.errors += 1
                    ...
                    case "GetReservation":
                        ...
                        if float(file[i][3]) > 0.000001:
                            service.latency.append(float(file[i][3]))
                            service.get_reservation.latency.append(float(file[i][3]))
                        else:
                            service.errors += 1
                    ...
                    case "CancelReservation":
                        ...
                        if float(file[i][3]) > 0.000001:
                            service.latency.append(float(file[i][3]))
                            service.cancel_reservation.latency.append(float(file[i][3]))
                        else:
                            service.errors += 1
                    ...
                    case "ModifyReservation":
                        ...
                        if float(file[i][3]) > 0.000001:
                            service.latency.append(float(file[i][3]))
                            service.modify_reservation.latency.append(float(file[i][3]))
                        else:
                            service.errors += 1
